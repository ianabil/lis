...
<div class="box box-default">
    <div class="box-header with-border">
        <h3 class="box-title">Upload Catalogue</h3>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    <label>Date</label>
                    <input type="text" class="form-control date" name="upload_catalogue_date_from" id="upload_catalogue_date_from" placeholder="From">
                    <br>
                    <input type="text" class="form-control date" name="upload_catalogue_date_to" id="upload_catalogue_date_to" placeholder="To">                    
                </div>
            </div>
            <!-- /.col -->
